...
import s from './magnetic-btn.module.css'
...
export const MagneticButton = ({
    ...
    return (
        <button
            ref={$root}
            className={`${s.magneticButton} ${s[className]}`}
        ...
        >
            {(className === 'learnMore' || className === 'slearnMore') && <div className={s.animatedBG}></div>}
            <span
                ref={$item}
                className={s.magneticButtonItem}
            >
                {children}
            </span>
            <span
                ref={$hover}
                className={s.magneticButtonHover}
            />
        </button>
    )
}